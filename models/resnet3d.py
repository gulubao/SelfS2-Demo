...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1, base_width=None, dilation=None,
                 norm_layer=None):
...
def resnet34(input_chunnel, middle_chunnel, out_chunnel, **kwargs):  ## 用的是这个
